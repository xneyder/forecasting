...
and KPI_NAME='LTE Voice Traffic Dedicated Bearers'
AND PERIOD_DATE=trunc(trunc(sysdate,'MM')-1,'MM');
INSERT INTO SMA_HLX.SMA_SUMMARY@KNOXHLXPRD
with pm_data as
(
        select /*+ materialize */ DATETIME, VMME_NAME,
        SUM(nvl(SM_NBRACTDEDICA_EPSBRRQCI5_MAX,0)) KPI,
        count(*) INSTANCE_COUNT
        from AFFIRMED_VMME.AFF_VMME_SRV_LTESMGEN_15M
...
'LTE Voice Traffic Dedicated Bearers' KPI_NAME,
'LTESM_GENERAL.SM.NbrActDedicatedEpsBearer.QCI5' INDICATOR_,
'MM' TIME_AGG_TYPE,
'PERC' MATH_AGG_TYPE,
90 PERCENTILE_USED,
