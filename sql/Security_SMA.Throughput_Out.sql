...
INSERT INTO AUDIT_DB.Security_SMA_2
...
INSERT INTO SMA_HLX.SMA_SUMMARY@KNOXHLXPRD
 select
   ...
   from AUDIT_DB.Security_SMA_2
  group by trunc(datetime,'MM'), LOCATION_GROUP;

drop table AUDIT_DB.Security_SMA_2
